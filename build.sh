...
NODES="iota-hornet iota-wasp iota-chronicle shimmer-hornet shimmer-wasp shimmer-chronicle shimmer-groupfi"
...
NodePackagesMenu() {
  print_menu "all" "iota-hornet" "iota-wasp" "iota-chronicle" "shimmer-hornet" "shimmer-wasp" "shimmer-chronicle" "shimmer-groupfi" "Back"
	read  -p '> ' n
	case ${n} in
  1) print_line
  ...
  7) print_line
     ...
     ;;
  8) print_line
     build_node "shimmer-groupfi" "interactive"
     enter_to_continue
	   NodePackagesMenu
     ;;
	*) MainMenu ;;
