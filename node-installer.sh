...
VAR_NOVA_INX_CHRONICLE_UPDATE=1
...
echo "║ DLT.GREEN           AUTOMATIC NODE-INSTALLER WITH DOCKER $VAR_VRN ║"
echo "║                                                                             ║"
echo "║$gr      ____    _      _____         ____   ____    _____   _____   _   _      $xx║"
echo "║$gr     |  _ \  | |    |_   _|       / ___| |  _ \  | ____| | ____| | \ | |     $xx║"
echo "║$gr     | | | | | |      | |        | |  _  | |_) | |  _|   |  _|   |  \| |     $xx║"
echo "║$gr     | |_| | | |___   | |    _   | |_| | |  _ <  | |___  | |___  | |\  |     $xx║"
echo "║$gr     |____/  |_____|  |_|   (_)   \____| |_| \_\ |_____| |_____| |_| \_|     $xx║"
echo "║                                                                             ║"
echo "║                                                                             ║"
