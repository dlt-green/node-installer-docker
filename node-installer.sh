...
VAR_SHIMMER_CORE_VERSION='1.0.0-alpha.20'
...
VAR_SHIMMER_INX_INDEXER_VERSION='2.0.0-alpha.24'
VAR_SHIMMER_INX_MQTT_VERSION='2.0.0-alpha.16'
VAR_SHIMMER_INX_BLOCKISSUER_VERSION='1.0.0-alpha.20'
VAR_SHIMMER_INX_VALIDATOR_VERSION='1.0.0-alpha.18'
...
ShimmerCore() {
	...
	if [ "$VAR_CONF_RESET" = 1 ]; then
		...
		echo "IOTA_CORE_ENTRY_NODE=\"/dns/iota-core-testnet.dlt.green/tcp/15600/p2p/12D3KooWNb9HJ6mr2dXLPLdYasucGH45a1oXKihcUoRo7owsWDFd\"" >> .env
