...
VAR_NOVA_IOTA_CORE_VERSION='1.0.0-beta.8'
VAR_NOVA_IOTA_CORE_UPDATE=0

VAR_NOVA_INX_INDEXER_VERSION='2.0.0-beta'
VAR_NOVA_INX_MQTT_VERSION='2.0.0-beta'
VAR_NOVA_INX_DASHBOARD_VERSION='2.0.0-beta'
VAR_NOVA_INX_BLOCKISSUER_VERSION='1.0.0-beta'
VAR_NOVA_INX_VALIDATOR_VERSION='1.0.0-beta'
