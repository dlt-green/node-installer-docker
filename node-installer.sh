...
VAR_SHIMMER_CORE_VERSION='1.0.0-alpha.6'
...
ShimmerCore() {
	...
	if [ "$VAR_CONF_RESET" = 1 ]; then
		...
		echo "IOTA_CORE_ENTRY_NODE=\"/dns/iota-core-testnet.dlt.green/tcp/15600/p2p/12D3KooWNXcNU3hHk6sk8M2aLYP6d33ALK3C4CgmqHNyA5Dw39Sp\"" >> .env
